...
export const EXERCISES = Object.freeze([
  ...
  { exerciseId: 'bench_press', nameVi: 'BB Bench Press', muscleGroup: 'Ngực', movementPattern: 'compound_pec',
    ...
    technique: [
      'Nằm ngửa, mắt ngay dưới thanh tạ. Kéo hai vai về sau và ép xuống ghế như đang nhét hai bả vai vào túi quần sau.',
      'Hạ tạ chậm rãi xuống ngực, khuỷu tay tạo góc khoảng 45 độ với thân — không xòe ngang như chữ T.',
      'Đạp chặt hai chân xuống sàn để tạo lực từ chân lên, rồi đẩy tạ lên như đang đẩy trần nhà ra xa.',
      'Lỗi thường gặp: để tạ nảy trên ngực, vai nhấc khỏi ghế khi đẩy lên.',
    ] },
  { exerciseId: 'db_bench_press', nameVi: 'DB Bench Press', muscleGroup: 'Ngực', movementPattern: 'accessory_pec',
    ...
    technique: [
      'Ngồi lên ghế trước, đặt hai tạ lên đùi, rồi nằm xuống trong lúc dùng đầu gối đẩy tạ lên tới ngực.',
      'Đẩy hai tạ lên như đang ôm một quả bóng lớn trước ngực — hai tạ đi theo đường vòng cung, không phải đường thẳng.',
      'Hạ tạ chậm xuống hai bên ngực, khuỷu tay hơi hướng ra ngoài chứ không thẳng góc 90 độ.',
      'Lỗi thường gặp: để hai tạ va vào nhau ở đỉnh làm mất lực, khuỷu tay xòe ngang quá mức khi hạ xuống.',
    ] },
  ...
  { exerciseId: 'barbell_row', nameVi: 'Barbell Rows', muscleGroup: 'Lưng', movementPattern: 'compound_back_horizontal',
    ...
    technique: [
      'Gập người khoảng 45 độ, lưng thẳng như một tấm ván, đầu gối hơi chùng, hai tay nắm tạ rộng bằng vai.',
      'Kéo thanh tạ về phía bụng dưới như đang giật dây khởi động máy cắt cỏ — dùng lưng kéo, không chỉ dùng tay.',
      'Ở cuối chuyển động, ép hai bả vai lại gần nhau như đang kẹp một cây bút chì giữa lưng.',
      'Lỗi thường gặp: đứng thẳng người lên rồi lắc đà để kéo tạ, thay vì giữ nguyên góc lưng.',
    ] },
  ...
  { exerciseId: 'lat_pulldown', nameVi: 'Lat Pull-down', muscleGroup: 'Lưng', movementPattern: 'accessory_back_vertical',
    ...
    defaultScheme: SCHEME.SET_THEN_REP_INCREASE, defaultParams: scheme8(),
    technique: [
      'Ngồi thẳng lưng, đùi được đệm giữ chắc phía trên, tay nắm thanh rộng hơn vai một chút.',
      'Kéo thanh xuống dưới cằm bằng cách ép khuỷu tay xuống và ra sau, như đang kéo một cành cây xuống thấp.',
      'Ưỡn ngực nhẹ khi kéo, không ngả cả người ra sau để mượn đà.',
      'Lỗi thường gặp: chỉ dùng cánh tay kéo mà quên ép lưng, hoặc kéo thanh xuống sau gáy (dễ chấn thương vai).',
    ] },
  ...
  { exerciseId: 'overhead_press', nameVi: 'Standing BB Overhead Press', muscleGroup: 'Vai', movementPattern: 'compound_shoulder',
    equipmentTags: ['barbell'], isBodyweight: false, videoUrl: 'https://www.youtube.com/watch?v=G2qpTG1Eh40',
    defaultScheme: SCHEME.LAST_SET_RIR, defaultParams: scheme2(75.0, 8),
    technique: [
      'Đứng thẳng, xiết chặt bụng như sắp bị ai đó thụi vào bụng, thanh tạ đặt ngang vai, tay nắm rộng hơn vai một chút.',
      'Đẩy tạ thẳng lên qua đầu, hơi ngả đầu ra sau nhẹ để tạ đi thẳng qua mặt chứ không đi vòng ra trước.',
      'Khi tạ qua khỏi đỉnh đầu, đưa đầu về lại vị trí bình thường để tạ nằm thẳng trên vai.',
      'Lỗi thường gặp: ưỡn lưng quá mức để mượn đà đẩy tạ lên, thay vì dùng lực vai thật sự.',
    ] },
  ...
  { exerciseId: 'lateral_raise', nameVi: 'DB Lateral Raise', muscleGroup: 'Vai', movementPattern: 'isolation_shoulder',
    ...
    defaultScheme: SCHEME.SET_THEN_REP_INCREASE, defaultParams: scheme8(),
    technique: [
      'Đứng thẳng, tay cầm tạ hai bên hông, khuỷu tay hơi chùng nhẹ (không thẳng cứng).',
      'Nâng tạ sang ngang như đang rót nước ra khỏi hai chiếc bình, nâng đến khi tay ngang vai.',
      'Hạ tạ xuống chậm rãi, có kiểm soát — đừng thả rơi.',
      'Lỗi thường gặp: lắc người lấy đà để hất tạ lên, hoặc nâng quá cao khỏi vai làm cơ vai trên gánh lực thay vì vai giữa.',
    ] },
  ...
  { exerciseId: 'squat', nameVi: 'BB Back Squat', muscleGroup: 'Đùi trước', movementPattern: 'compound_knee',
    ...
    defaultScheme: SCHEME.LAST_SET_RIR, defaultParams: scheme2(87.5, 3),
    technique: [
      'Đặt thanh tạ lên phần cơ vai trên (không phải lên cổ), tay nắm rộng hơn vai một chút, đứng rộng bằng vai.',
      'Hít sâu, ưỡn ngực, hạ người xuống như đang ngồi vào một chiếc ghế thấp phía sau bạn.',
      'Đầu gối đẩy ra ngoài theo hướng mũi chân, không để đầu gối đổ vào trong.',
      'Đứng lên bằng lực đẩy từ gót chân xuống sàn, thở ra khi gần hết chuyển động.',
      'Lỗi thường gặp: nhón gót chân, đầu gối đổ vào trong, lưng cong tròn khi xuống sâu.',
    ] },
  ...
  { exerciseId: 'leg_press', nameVi: 'Leg Press', muscleGroup: 'Đùi trước', movementPattern: 'accessory_knee',
    ...
    defaultScheme: SCHEME.SET_THEN_REP_INCREASE, defaultParams: scheme8(),
    technique: [
      'Đặt chân rộng bằng vai trên bệ đạp, lưng và hông áp sát vào ghế.',
      'Hạ bệ xuống từ từ cho đến khi đầu gối gần chạm ngực, giữ hông không nhấc khỏi ghế.',
      'Đẩy bệ lên bằng lực từ gót chân, không khóa cứng đầu gối ở điểm cao nhất.',
      'Lỗi thường gặp: hạ quá sâu làm hông cong lên khỏi ghế (dễ đau lưng dưới).',
    ] },
  ...
  { exerciseId: 'deadlift', nameVi: 'Conventional Deadlift', muscleGroup: 'Đùi sau & Mông', movementPattern: 'compound_hip',
    equipmentTags: ['barbell'], isBodyweight: false, videoUrl: 'https://www.youtube.com/watch?v=AweC3UaM14o',
    defaultScheme: SCHEME.LAST_SET_RIR, defaultParams: scheme2(87.5, 3),
    technique: [
      'Đứng sát thanh tạ (ống chân gần chạm tạ), cúi xuống nắm tạ rộng bằng vai.',
      'Hạ hông xuống, giữ lưng thẳng như một tấm ván, ngực hướng về phía trước.',
      'Kéo tạ sát theo ống chân khi đứng lên, đẩy hông về phía trước ở cuối chuyển động như đang đóng cửa bằng hông.',
      'Lỗi thường gặp: nâng chủ yếu bằng lưng khiến lưng cong tròn, để tạ trôi ra xa khỏi người.',
    ] },
  ...
  { exerciseId: 'lying_ezbar_skullcrusher', nameVi: 'Lying EZ-Bar Skullcrusher', muscleGroup: 'Tay sau', movementPattern: 'isolation_triceps',
    equipmentTags: ['barbell'], isBodyweight: false, videoUrl: 'https://www.youtube.com/watch?v=l3rHYPtMUo8',
    defaultScheme: SCHEME.SET_THEN_REP_INCREASE, defaultParams: scheme8(2.5) },
  ...
  { exerciseId: 'hanging_leg_raise', nameVi: 'Hanging Leg Raise', muscleGroup: 'Bụng', movementPattern: 'isolation_core',
    ...
    defaultScheme: SCHEME.SET_THEN_REP_INCREASE, defaultParams: scheme8(2.5),
    technique: [
      'Treo người trên xà, hai tay nắm rộng bằng vai, thân người không đung đưa.',
      'Cuộn tròn xương chậu lên trước trước, rồi mới kéo chân lên cao — như đang cuộn một tờ giấy từ dưới lên.',
      'Hạ chân xuống chậm rãi, có kiểm soát, không thả rơi.',
      'Lỗi thường gặp: đung đưa người lấy đà, chỉ gập hông hất chân lên mà quên cuộn bụng.',
    ] },
